...
parser.add_argument('--id_class', type=str, default='Pullover', required=False, help='In-distribution class in the FashionMNIST datastet. By default the Pullover class is considered ID.')
